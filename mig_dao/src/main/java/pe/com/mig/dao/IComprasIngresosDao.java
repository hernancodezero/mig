...
/**
 * @className: IComprasIngresosDao.java
 * @description: 
 * @date: 14 de jun. de 2016
 * @author: SUMERIO.
 */
public interface IComprasIngresosDao {
	 ...
	 * @throws Exception
	 */
	public abstract List<ComprasIngresosBean> listarComprasSerie(ComprasIngresosBean compra) throws Exception;	
	/**
	 * @param compra
	 * @return
	 * @throws Exception
	 ...
	 * @throws Exception 
	 */
	public abstract List<DetalleComprasBean> listarDetalleCompraTransferencia(ComprasIngresosBean compra) throws Exception;
