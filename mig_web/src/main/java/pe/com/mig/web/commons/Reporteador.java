package pe.com.mig.web.commons; 
...
import org.apache.poi.hssf.usermodel.HSSFWorkbook; //Crea libro excel
...
//			Paragraph extra = null;
            ...
            if (compra.getCod_servicio().equals(Constantes.ONE_INT)) { // Consolidado de Partidas por Rendición de Cuenta
				...
				if (tip_operacion.equals(Constantes.TWO_STRING)) { // Sede Central
					...
					for (ReporteDetalleComprasBean rep_compra : lista) {
						...
						p = new Paragraph(rep_compra.getDes_tip_documento(), normal);
						cell = new PdfPCell(p);
						cell.setBorder(Rectangle.NO_BORDER);
						table.addCell(cell);
						...
						p = new Paragraph(dec_form.format(imp_afecto), normal);
						cell = new PdfPCell(p);
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
						cell.setBorder(Rectangle.NO_BORDER);
						table.addCell(cell);
						...
						p = new Paragraph(dec_form.format(imp_no_afecto), normal);
						cell = new PdfPCell(p);
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
						cell.setBorder(Rectangle.NO_BORDER);
						table.addCell(cell);
						...
						p = new Paragraph(dec_form.format(imp_igv), normal);
						cell = new PdfPCell(p);
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
						cell.setBorder(Rectangle.NO_BORDER);
						table.addCell(cell);
						...
						p = new Paragraph(dec_form.format(imp_isc), normal);
						cell = new PdfPCell(p);
						cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
						cell.setBorder(Rectangle.NO_BORDER);
						table.addCell(cell);
						...
						if (rep_compra.getCod_moneda().equals(Constantes.ONE_INT)) { // Soles
							...
							p = new Paragraph(dec_form.format(det_total), normal);
							cell = new PdfPCell(p);
							cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cell.setBorder(Rectangle.NO_BORDER);
							table.addCell(cell);
							...
							if (rep_compra.getNum_tip_cambio() != null && rep_compra.getNum_tip_cambio().compareTo(BigDecimal.ZERO) > 0) {
								...
								BigDecimal det_total_dolares = rep_compra.getImp_det_total_dolares();
								if (cod_not_credito.equals(rep_compra.getCod_comprobante()) && // Nota de Credito
										det_total_dolares.compareTo(BigDecimal.ZERO) == 1) { // Mayor a cero
									det_total_dolares = det_total_dolares.negate();
								}
								
								p = new Paragraph(dec_form.format(det_total_dolares), normal);
								cell = new PdfPCell(p);
								cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
								cell.setBorder(Rectangle.NO_BORDER);
								table.addCell(cell);
								...
								imp_det_dol_total = imp_det_dol_total.add(det_total_dolares);
								imp_dol_total = imp_dol_total.add(det_total_dolares);
					...
					table = new PdfPTable(cell_ven);
					p = new Paragraph(anp.concat(are_nat_pro), negrita);
					cell = new PdfPCell(p);
					cell.setBorder(Rectangle.NO_BORDER);
					cell.setColspan(11);
					table.addCell(cell);
					...
					for (ReporteDetalleComprasBean rep_compra : lis_uni_ope) {
						...
						if (rep_compra.getCod_moneda().equals(Constantes.ONE_INT)) { // Soles
			    	    	...
			    	    	if (rep_compra.getNum_tip_cambio() != null && rep_compra.getNum_tip_cambio().compareTo(BigDecimal.ZERO) > 0) {
					    	    ...
					    	    imp_det_dol_total = imp_det_dol_total.add(det_total_dolares);
					    	    imp_dol_total = imp_dol_total.add(det_total_dolares);
					    	    imp_tot_gen_dolares = imp_tot_gen_dolares.add(det_total_dolares);
						...
						if (can == ult) { // Validacion ultimo registro
							...
							p = new Paragraph(dec_form.format(imp_tot_gen_afecto.add(sed_num_imp_tot_afecto)), negrita);
							cell = new PdfPCell(p);
							cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cell.setBorder(Rectangle.TOP);
							table.addCell(cell);
							
							p = new Paragraph(dec_form.format(imp_tot_gen_no_afecto.add(sed_num_imp_tot_no_afecto)), negrita);
							cell = new PdfPCell(p);
							cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cell.setBorder(Rectangle.TOP);
							table.addCell(cell);
							
							p = new Paragraph(dec_form.format(imp_tot_gen_igv.add(sed_num_imp_tot_igv)), negrita);
							cell = new PdfPCell(p);
							cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cell.setBorder(Rectangle.TOP);
							table.addCell(cell);
							
							p = new Paragraph(dec_form.format(imp_tot_gen_isc.add(sed_num_imp_tot_isc)), negrita);
							cell = new PdfPCell(p);
							cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cell.setBorder(Rectangle.TOP);
							table.addCell(cell);
							
							p = new Paragraph(dec_form.format(imp_tot_gen_soles.add(sed_imp_total)), negrita);
							cell = new PdfPCell(p);
							cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cell.setBorder(Rectangle.TOP);
							table.addCell(cell);
							
							p = new Paragraph(dec_form.format(imp_tot_gen_dolares.add(sed_imp_dol_total)), negrita);
							cell = new PdfPCell(p);
							cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
							cell.setBorder(Rectangle.TOP);
							table.addCell(cell);
	...
	public void generaExcelReporteCompras(HttpServletResponse response, ComprasIngresosBean compra, List<ReporteDetalleComprasBean> lista) {
		try{
	        ...
	        if (compra.getCod_servicio().equals(Constantes.ONE_INT)) { // Consolidado de Partidas por Rendición de Cuenta
	        	...
	        	String fec_sistema = "Fecha del Reporte : ";
            	String fec_actual = DateUtil.obtenerFechaFormateada(Constantes.FORMATO_FECHA, new Date());
	        	row3.createCell(7).setCellValue(fec_sistema.concat(fec_actual));	        
	        	row3.getCell(7).setCellStyle(style_hed);			        		
	        } else if (compra.getCod_servicio().equals(Constantes.TWO_INT)) {  // Documentos de la Rendición de Cuenta	        
	        	...
	        	String fec_sistema = "Fecha del sistema : ";
            	String fec_actual = DateUtil.obtenerFechaFormateada(Constantes.FORMATO_FECHA, new Date());
	        	row3.createCell(19).setCellValue(fec_sistema.concat(fec_actual));	        
	        	row3.getCell(19).setCellStyle(style_hed);		        
	        } else if (compra.getCod_servicio().equals(Constantes.THREE_INT)) { // Reporte de Compras
	        	String fec_sistema = "Fecha del sistema : ";
            	String fec_actual = DateUtil.obtenerFechaFormateada(Constantes.FORMATO_FECHA, new Date());
	        ...
	        if (compra.getCod_servicio().equals(Constantes.ONE_INT) && !isNullOrEmpty(compra.getNro_cp())) { //Consolidado de Comprobantes
	        	HSSFRichTextString tex_transf_cp = new HSSFRichTextString("Nro Transferecia: ");
	        	HSSFRichTextString tex_transf_rc = new HSSFRichTextString("Nro Rendición: ");
		        //HSSFRichTextString det_transf_cp = new HSSFRichTextString(getString(rep_com_tra.getNro_sia_operacion()));	        	
	        	HSSFRichTextString det_transf_cp = new HSSFRichTextString(getString(compra.getNro_cp()));
		        HSSFRichTextString det_transf_rc = new HSSFRichTextString(getString(compra.getNro_cp()));		        
		        RichTextString det_rango_cp = new HSSFRichTextString(tex_transf_cp.getString() + det_transf_cp.getString());
		        RichTextString det_rango_rc = new HSSFRichTextString(tex_transf_rc.getString() + det_transf_rc.getString());
		        det_rango_cp.applyFont(0, 8, font_bold);
		        det_rango_rc.applyFont(0, 8, font_bold);
		        row5.createCell(1).setCellValue(det_rango_cp);	   
		        row6.createCell(1).setCellValue(det_rango_rc);
	        }	        
	        
	        if (compra.getCod_servicio().equals(Constantes.TWO_INT) ) { //Detalle de Comprobantes
		        ...
		        HSSFRichTextString det_transf_cp = new HSSFRichTextString(getString(rep_com_tra.getNro_cp()));
		        HSSFRichTextString det_transf_rc = new HSSFRichTextString(getString(rep_com_tra.getNro_doc_rc()));
	        ...
	        if (compra.getCod_servicio().equals(Constantes.ONE_INT)) { // Consolidado de Partidas por Rendición de Cuenta
		        ...
		        row9.createCell(3).setCellValue("Meta");
		        row9.getCell(3).setCellStyle(style_header);
		        
		        row9.createCell(4).setCellValue("POA");
		        row9.getCell(4).setCellStyle(style_header);
		        
		        row9.createCell(5).setCellValue("Transferido");
		        row9.getCell(5).setCellStyle(style_header);
		        
		        row9.createCell(6).setCellValue("Ejecutado");
		        row9.getCell(6).setCellStyle(style_header);
		        
		        row9.createCell(7).setCellValue("Devoluciones");
		        row9.getCell(7).setCellStyle(style_header);
		        
		        row9.createCell(8).setCellValue("Saldo");
		        ...
		        for (ReporteDetalleComprasBean rep_compra : lista) {
			        ...
			        rows.createCell(3).setCellValue(getString(rep_compra.getCod_meta()));
			        rows.getCell(3).setCellStyle(style_cell);
			        			        
			        rows.createCell(4).setCellValue(dec_form.format(rep_compra.getImp_partida()));
			        rows.getCell(4).setCellStyle(style_mont);
			        
			        rows.createCell(5).setCellValue(dec_form.format(rep_compra.getImp_partida()));
			        rows.getCell(5).setCellStyle(style_mont);
			        
			        rows.createCell(6).setCellValue(dec_form.format(rep_compra.getImp_det_total()));
			        ...
			        rows.createCell(8).setCellValue(dec_form.format(rep_compra.getImp_saldo()));
		        ...
		        row_total.createCell(4).setCellValue(dec_form.format(num_poa));
		        row_total.getCell(4).setCellStyle(style_tot_mont);
		        
		        row_total.createCell(5).setCellValue(dec_form.format(num_tra));
		        row_total.getCell(5).setCellStyle(style_tot_mont);
		        
		        row_total.createCell(6).setCellValue(dec_form.format(num_eje));
		        ...
		        row_total.createCell(8).setCellValue(dec_form.format(num_sal));
		        row_total.getCell(8).setCellStyle(style_tot_mont);		        
				...
				row7.createCell(17).setCellValue("");
				row7.getCell(17).setCellStyle(style_bottom);	
				row7.createCell(18).setCellValue("");
				row7.getCell(18).setCellStyle(style_bottom);	
				row7.createCell(19).setCellValue("");
				row7.getCell(19).setCellStyle(style_bottom);	
		        ...
		        row8.createCell(16).setCellValue("IMPORTE");
		        row8.getCell(16).setCellStyle(style_header);
		        ...
		        row9.createCell(5).setCellValue("Meta");
		        row9.getCell(5).setCellStyle(style_header);

		        row9.createCell(6).setCellValue("Fecha C/P");
		        row9.getCell(6).setCellStyle(style_header);
		        
		        row9.createCell(7).setCellValue("SIAF");
		        row9.getCell(7).setCellStyle(style_header);
		        
		        row9.createCell(8).setCellValue("Comp. de Pago");
		        row9.getCell(8).setCellStyle(style_header);
		        
		        row9.createCell(9).setCellValue("Nro C/P");
		        row9.getCell(9).setCellStyle(style_header);
		        
		        row9.createCell(10).setCellValue("RUC");
		        row9.getCell(10).setCellStyle(style_header);
		        
		        row9.createCell(11).setCellValue("Razon Social");
		        row9.getCell(11).setCellStyle(style_header);
		        
		        row9.createCell(12).setCellValue("Tipo Orden");
		        row9.getCell(12).setCellStyle(style_header);

		        row9.createCell(13).setCellValue("Nro Orden");
		        row9.getCell(13).setCellStyle(style_header);
		        
		        row9.createCell(14).setCellValue("Fec.Orden");
		        row9.getCell(14).setCellStyle(style_header);
		        
		        row9.createCell(15).setCellValue("Retencion IGV");
		        row9.getCell(15).setCellStyle(style_header);
		        		        
		        row9.createCell(16).setCellValue("Monto");
		        row9.getCell(16).setCellStyle(style_header);
		        
		        row9.createCell(17).setCellValue("Afecto");
		        row9.getCell(17).setCellStyle(style_header);
		
		        row9.createCell(18).setCellValue("No Afecto");
		        row9.getCell(18).setCellStyle(style_header);
		
		        row9.createCell(19).setCellValue("IGV");
		        row9.getCell(19).setCellStyle(style_header);
		
		        row9.createCell(20).setCellValue("ISC");
		        row9.getCell(20).setCellStyle(style_header);
		
		        row9.createCell(21).setCellValue("Total");
		        ...
		        for (ReporteDetalleComprasBean rep_compra : lista) {
			        ...
			        rows.createCell(5).setCellValue(rep_compra.getCod_meta());
			        rows.getCell(5).setCellStyle(style_cell);
			        
			        rows.createCell(6).setCellValue(rep_compra.getFec_comprobante());
			        rows.getCell(6).setCellStyle(style_cell);
			        
			        rows.createCell(7).setCellValue(getString(rep_compra.getNro_siaf()));
			        rows.getCell(7).setCellStyle(style_cell);
			        
			        rows.createCell(8).setCellValue(rep_compra.getTip_comprobante());
			        rows.getCell(8).setCellStyle(style_cell);
			        
			        rows.createCell(9).setCellValue(rep_compra.getNro_ser_comprobante());
			        rows.getCell(9).setCellStyle(style_cell);
			        
			        rows.createCell(10).setCellValue(rep_compra.getRuc_nro_doc_prov());
			        rows.getCell(10).setCellStyle(style_cell);
			        
			        rows.createCell(11).setCellValue(rep_compra.getRaz_soc_prov());
			        rows.getCell(11).setCellStyle(style_cell);

			        rows.createCell(12).setCellValue(rep_compra.getTip_orden());
			        rows.getCell(12).setCellStyle(style_cell);				       
			        
			        rows.createCell(13).setCellValue(rep_compra.getNum_orden());
			        rows.getCell(13).setCellStyle(style_cell);	

			        rows.createCell(14).setCellValue(rep_compra.getFec_orden());
			        rows.getCell(14).setCellStyle(style_cell);	
			        
			        rows.createCell(15).setCellValue(rep_compra.getInd_cp_reten());
			        rows.getCell(15).setCellStyle(style_cell);	   
		
		            rows.createCell(16).setCellValue(dec_form.format(rep_compra.getNum_imp_servicio()));
			        rows.getCell(16).setCellStyle(style_mont);
		            
			        rows.createCell(17).setCellValue(dec_form.format(rep_compra.getNum_imp_afecto()));
			        rows.getCell(17).setCellStyle(style_mont);
		
			        rows.createCell(18).setCellValue(dec_form.format(rep_compra.getNum_imp_no_afecto()));
			        rows.getCell(18).setCellStyle(style_mont);
		
			        rows.createCell(19).setCellValue(dec_form.format(rep_compra.getNum_imp_igv()));
			        rows.getCell(19).setCellStyle(style_mont);
		
			        rows.createCell(20).setCellValue(dec_form.format(rep_compra.getNum_imp_isc()));
			        rows.getCell(20).setCellStyle(style_mont);
		
			        rows.createCell(21).setCellValue(dec_form.format(rep_compra.getImp_det_total()));
			        rows.getCell(21).setCellStyle(style_mont);
		        ...
		        HSSFRichTextString total = new HSSFRichTextString("Totales:");
		        total.applyFont(font_bold);
		        row_total.createCell(16).setCellValue(total);
		        
		        row_total.createCell(17).setCellValue(dec_form.format(num_imp_afecto));
		        row_total.getCell(17).setCellStyle(style_tot_mont);
		        
		        row_total.createCell(18).setCellValue(dec_form.format(num_imp_no_afecto));
		        row_total.getCell(18).setCellStyle(style_tot_mont);
		        
		        row_total.createCell(19).setCellValue(dec_form.format(num_imp_igv));
		        row_total.getCell(19).setCellStyle(style_tot_mont);
		        
		        row_total.createCell(20).setCellValue(dec_form.format(num_imp_isc));
		        row_total.getCell(20).setCellStyle(style_tot_mont);
		        
		        row_total.createCell(21).setCellValue(dec_form.format(imp_det_total));
		        row_total.getCell(21).setCellStyle(style_tot_mont);
		        ...
		        for (ReporteDetalleComprasBean rep_compra : lista) {
			      ...
			      //Columna 10
			        ...
			        rows.createCell(13).setCellValue(dec_form.format(imp_afecto));
			        ...
			        rows.createCell(14).setCellValue(dec_form.format(imp_igv));
	            ...
	            if (tip_operacion.equals(Constantes.TWO_STRING)) { // Sede Central
	            	...
	            	for (ReporteDetalleComprasBean rep_compra : lista) {
			    	    ...
			    	    rows.createCell(3).setCellValue(rep_compra.getDes_tip_documento());
			    	    rows.getCell(3).setCellStyle(style_cell);
			    	    ...
			    	    if (rep_compra.getCod_moneda().equals(Constantes.ONE_INT)) { // Soles
							...
							if (rep_compra.getNum_tip_cambio() != null && rep_compra.getNum_tip_cambio().compareTo(BigDecimal.ZERO) > 0) {
								...
								rows.createCell(11).setCellValue(dec_form.format(det_total_dolares));
								rows.getCell(11).setCellStyle(style_mont);
            ...
            if (!ingreso.getTip_transaccion().equals(Constantes.SIX_STRING) && // Registro de Ventas
				...
				if (tip_operacion.equals(Constantes.TWO_STRING)) { // Sede Central
					...
					for (ReporteDetalleIngresosBean rep_ingreso : lista) {
		            	...
		            	if (cod_not_credito.equals(rep_ingreso.getCod_comprobante()) && // Nota de Credito
		            			imp_afecto.compareTo(BigDecimal.ZERO) == 1) { // Mayor a cero
		            		imp_afecto = imp_afecto.negate();
		            	}
						...
						if (rep_ingreso.getCod_moneda().equals(Constantes.ONE_INT)) { // Soles
							...
							BigDecimal det_total = rep_ingreso.getImp_det_total();
			            	if (cod_not_credito.equals(rep_ingreso.getCod_comprobante()) && // Nota de Credito
			            			det_total.compareTo(BigDecimal.ZERO) == 1) { // Mayor a cero
			            		det_total = det_total.negate();
			            	}
							...
							if (rep_ingreso.getNum_tip_cambio() != null && rep_ingreso.getNum_tip_cambio().compareTo(BigDecimal.ZERO) > 0) {
								...
								BigDecimal det_total_dolares = rep_ingreso.getImp_det_total_dolares();
								if (cod_not_credito.equals(rep_ingreso.getCod_comprobante()) && // Nota de Credito
										det_total_dolares.compareTo(BigDecimal.ZERO) == 1) { // Mayor a cero
									det_total_dolares = det_total_dolares.negate();
								}
	...
	public void generaExcelReporteIngresos(HttpServletResponse response, ComprasIngresosBean ingreso, List<ReporteDetalleIngresosBean> lista) {
    	try{
	        ...
	        if (!ingreso.getTip_transaccion().equals(Constantes.SIX_STRING) &&
		        ...
		        */
		        row7.createCell(4).setCellValue("Fecha C/P");
		        row7.getCell(4).setCellStyle(style_header);
		        
		        row7.createCell(5).setCellValue("Tipo Moneda");
		        row7.getCell(5).setCellStyle(style_header);
		        
		        row7.createCell(6).setCellValue("Tipo Cambio");
		        ...
		        */
		        row7.createCell(7).setCellValue("RUC");
		        row7.getCell(7).setCellStyle(style_header);
		        
		        row7.createCell(8).setCellValue("Razon Social");
		        row7.getCell(8).setCellStyle(style_header);
	            ...
	            if (!isNullOrEmpty(ingreso.getTip_transaccion())) {
	            	if (ingreso.getTip_transaccion().equals(Constantes.ONE_STRING)) { // Servicio
	            		...
	            		row7.createCell(9).setCellValue("Servicio");
	        	        row7.getCell(9).setCellStyle(style_header);
	        	        
	        	        row7.createCell(10).setCellValue("Dias");
						...
						row7.createCell(9).setCellValue("Producto");
	        	        row7.getCell(9).setCellStyle(style_header);
	        	        
	        	        row7.createCell(10).setCellValue("Cantidad");
	        	        row7.getCell(10).setCellStyle(style_header);
	        	        
	        	        posicion = posicion + 2;
					} else if (ingreso.getTip_transaccion().equals(Constantes.THREE_STRING)) { // Boleto
						//row7.createCell(12).setCellValue("Serie Tarifa");
						row7.createCell(9).setCellValue("Serie Tarifa");
	        	        row7.getCell(9).setCellStyle(style_header);
						
						row7.createCell(10).setCellValue("Tarifa");
	        	        row7.getCell(10).setCellStyle(style_header);
	        	        
	        	        row7.createCell(11).setCellValue("Nro. Inicio");
	        	        row7.getCell(11).setCellStyle(style_header);
	        	        
	        	        row7.createCell(12).setCellValue("Nro. Fin");
						...
						row7.createCell(9).setCellValue("TUPA");
	        	        row7.getCell(9).setCellStyle(style_header);
	        	        
	        	        row7.createCell(10).setCellValue("Tarifa");
	        	        row7.getCell(10).setCellStyle(style_header);
	        	        
	        	        row7.createCell(11).setCellValue("Cantidad");
	        	        row7.getCell(11).setCellStyle(style_header);
	        	        
	        	        posicion = posicion + 3;
					} else if (ingreso.getTip_transaccion().equals(Constantes.FIVE_STRING)) { // Otro
						//row7.createCell(12).setCellValue("Tarifa");
						row7.createCell(9).setCellValue("Tarifa");
	        	        row7.getCell(9).setCellStyle(style_header);
	    	        ...
	    	        row7.createCell(10).setCellValue("Producto");
	    	        row7.getCell(10).setCellStyle(style_header);
	    	        
	    	        row7.createCell(11).setCellValue("TUPA");
	    	        row7.getCell(11).setCellStyle(style_header);
	    	        
	    	        row7.createCell(12).setCellValue("Serie Tarifa");
	    	        row7.getCell(12).setCellStyle(style_header);
	    	        
	    	        row7.createCell(13).setCellValue("Tarifa Boleto");
	    	        row7.getCell(13).setCellStyle(style_header);
	    	        ...
	    	        row7.createCell(16).setCellValue("Tarifa Tupa");
	    	        row7.getCell(16).setCellStyle(style_header);
	    	        
	    	        row7.createCell(17).setCellValue("Tarifa Otros");
	    	        row7.getCell(17).setCellStyle(style_header);
	    	        
	    	        row7.createCell(18).setCellValue("Cantidad");
	    	        row7.getCell(18).setCellStyle(style_header);
	    	        
	    	        row7.createCell(19).setCellValue("Dias");
	            ...
	            for (ReporteDetalleIngresosBean rep_ingreso : lista) {
	    	        ...
	    	        rows.getCell(4).setCellStyle(style_cell);    	        
	    	        */
	    	        rows.createCell(4).setCellValue(rep_ingreso.getFec_comprobante());
	    	        rows.getCell(4).setCellStyle(style_cell);
	    	        
	    	        rows.createCell(5).setCellValue(rep_ingreso.getTip_moneda());
	    	        rows.getCell(5).setCellStyle(style_cell);
	    	        
	    	        rows.createCell(6).setCellValue(getString(rep_ingreso.getNum_tip_cambio()));
	    	        rows.getCell(6).setCellStyle(style_cell);
	    	        /*
	    	        ...
	    	        rows.getCell(9).setCellStyle(style_cell);
	    	        */
	    	        rows.createCell(7).setCellValue(getString(rep_ingreso.getRuc_nro_doc_prov()));
	    	        rows.getCell(7).setCellStyle(style_cell);
	    	        
	    	        rows.createCell(8).setCellValue(getString(rep_ingreso.getRaz_soc_prov()));
	    	        rows.getCell(8).setCellStyle(style_cell);
	                ...
	                if (!isNullOrEmpty(ingreso.getTip_transaccion())) {
	                	if (ingreso.getTip_transaccion().equals(Constantes.ONE_STRING)) {
	                		rows.createCell(9).setCellValue(rep_ingreso.getDes_servicio());
	                		rows.getCell(9).setCellStyle(style_cell);
	            	        
	            	        rows.createCell(10).setCellValue(rep_ingreso.getCan_dias());
	            	        rows.getCell(10).setCellStyle(style_cell);
	            	        
	            	        pos_cell = pos_cell + 2;
	    				} else if (ingreso.getTip_transaccion().equals(Constantes.TWO_STRING)) {
	    					rows.createCell(9).setCellValue(rep_ingreso.getNom_producto());
	                        rows.getCell(9).setCellStyle(style_cell);
	            	        
	                        rows.createCell(10).setCellValue(rep_ingreso.getCan_producto().doubleValue());
	                        rows.getCell(10).setCellStyle(style_cell);
	            	        
	            	        pos_cell = pos_cell + 2;
	    				} else if (ingreso.getTip_transaccion().equals(Constantes.THREE_STRING)) { // Boletos
	    					rows.createCell(9).setCellValue(rep_ingreso.getNum_ser_boleto());
	                        rows.getCell(9).setCellStyle(style_cell);
	    					
	    					rows.createCell(10).setCellValue(rep_ingreso.getDes_boleto());
	                        rows.getCell(10).setCellStyle(style_cell);
	                        
	                        rows.createCell(11).setCellValue(getString(rep_ingreso.getIni_boleto()));
	                        rows.getCell(11).setCellStyle(style_cell);
	                        
	                        rows.createCell(12).setCellValue(getString(rep_ingreso.getFin_boleto()));
	                        rows.getCell(12).setCellStyle(style_cell);
	            	        
	                        rows.createCell(13).setCellValue(rep_ingreso.getCan_producto().doubleValue());
	                        rows.getCell(13).setCellStyle(style_cell);
	            	        
	            	        pos_cell = pos_cell + 5;
	    				} else if (ingreso.getTip_transaccion().equals(Constantes.FOUR_STRING)) {
	    					rows.createCell(9).setCellValue(rep_ingreso.getVcod_tupa());
	                        rows.getCell(9).setCellStyle(style_cell);
	    					
	    					rows.createCell(10).setCellValue(rep_ingreso.getNom_tupa());
	                        rows.getCell(10).setCellStyle(style_cell);
	            	        
	                        rows.createCell(11).setCellValue(rep_ingreso.getCan_producto().doubleValue());
	                        rows.getCell(11).setCellStyle(style_cell);
	            	        
	            	        pos_cell = pos_cell + 3;
	    				} else if (ingreso.getTip_transaccion().equals(Constantes.FIVE_STRING)) {
	    					rows.createCell(9).setCellValue(rep_ingreso.getDes_otros());
	                        rows.getCell(9).setCellStyle(style_cell);
	                	...
	                	rows.createCell(10).setCellValue(getString(rep_ingreso.getDes_servicio()));
	                    rows.getCell(10).setCellStyle(style_cell);
	        	        
	                    rows.createCell(11).setCellValue(getString(rep_ingreso.getNom_producto()));
	                    rows.getCell(11).setCellStyle(style_cell);
	                    
	                    rows.createCell(12).setCellValue(rep_ingreso.getVcod_tupa());
	                    rows.getCell(12).setCellStyle(style_cell);
	                    
	                    rows.createCell(13).setCellValue(getString(rep_ingreso.getNum_ser_boleto()));
	                    rows.getCell(13).setCellStyle(style_cell);
	                    
	                    rows.createCell(14).setCellValue(getString(rep_ingreso.getDes_boleto()));
	                    rows.getCell(14).setCellStyle(style_cell);
	                    
	                    rows.createCell(15).setCellValue(getString(rep_ingreso.getIni_boleto()));
	                    rows.getCell(15).setCellStyle(style_cell);
	                    
	                    rows.createCell(16).setCellValue(getString(rep_ingreso.getFin_boleto()));
	                    rows.getCell(16).setCellStyle(style_cell);
	        	        
	                    rows.createCell(17).setCellValue(getString(rep_ingreso.getNom_tupa()));
	                    rows.getCell(17).setCellStyle(style_cell);
	                    
	                    rows.createCell(18).setCellValue(getString(rep_ingreso.getDes_otros()));
	                    rows.getCell(18).setCellStyle(style_cell);
	        	        
	                    rows.createCell(19).setCellValue(getString(rep_ingreso.getCan_producto()));
	                    rows.getCell(19).setCellStyle(style_cell);
	                    
	                    rows.createCell(20).setCellValue(getString(rep_ingreso.getCan_dias()));
	 ...
	 */
	private String getGenerarError(String nombre, String nivel, String nombreClase, String mensaje, int linea) {
