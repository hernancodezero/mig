...
<html lang="es">
	<head>
		...
		<meta charset="utf-8" />
		<title>Mantenimiento de Otros Conceptos</title>
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
				...
				<div class="main-content-inner">
					...
					<div class="breadcrumbs" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Mantenimiento de Otros Conceptos</li>
						</ul>
					</div>
								...
								<form class="form-horizontal" role="form">
									...
									<fieldset class="fsStyle">
										...
										<div class="form-group">	
											...
											-->				
												<div class="form-group">
													<label class="col-sm-2 control-label label-sm no-padding-right">Descripción del Concepto:</label>
													<div class="col-sm-4">
									...
									<table class="table table-striped table-bordered table-hover">
										<thead>
											<tr>
												<th>Item</th>
												<th>Codigo</th>
												<th>Descripcion Otros Conceptos</th>
												<th>Siglas</th>
												<th>Nombre</th>
												<th>Usuario</th>
											</tr>
			...
			<div id="div_tip_otros" class="modal" tabindex="-1" data-keyboard="false" data-backdrop="static">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<button type="button" class="close" data-dismiss="modal">&times;</button>
							<h4 id="h_tip_otros" class="white bigger center"></h4>
						</div>
						
						<div class="modal-body">
							<div class="row">
								<div class="col-xs-12">
									<form id="form_tip_otros" class="form-horizontal" role="form">
										<div class="form-group">																				
										...
										<div class="form-group">																				
											<label class="col-sm-3 control-label input-sm no-padding-right">Nombre Otro Concepto:</label>											
											<div class="col-sm-9">
												<input type="text" id="txt_nom_otros" class="form-control input-sm" maxlength="50" />
											</div>	
										</div>									
		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				$('#btn_buscar').click(function(e) {					
				 ...
				 $('#txt_nom_otros').keyup(function() {
				        this.value = this.value.toUpperCase();
				   });
				
				$('#btn_nuevo').click(function(e) {					
					e.preventDefault();
					$('#h_tip_otros').html('Registro de Otros Conceptos');
					$('#form_tip_otros').trigger("reset");
					$('#div_tip_otros').modal('show');
				});
				
				$('#btn_grabar').click(function(e) {					
					e.preventDefault();
					
					var cod_otro = $('#txt_mnt_codigo').val();
					var nom_otro = $('#txt_nom_otros').val();
					...
					if (esnulo(nom_otro)) {
						msg = msg + 'Campo "Nombre de Otro Concepto" es Obligatoria.<br/>';
					}
			...
			function search() {
				var href = '/listarOtros';				
				var fla_activo = 'N';
				if ($('#chk_activo').is(':checked')) {
					fla_activo = 'S';
				}				
				var params = {
					cod_otro : $('#txt_codigo').val(),
					nom_otro : $('#txt_nom_otros').val(),
					fla_activo : fla_activo
				};
				var fields = [
					'cod_otro',
				...
				var layout = [{
					...
					title: 'Denominacion Otro Concepto',
					field: 'nom_otro',				
				}, {		
					title: 'Siglas',
					field: 'siglas',				
			...
			function editar(object) {				
				$.ajax({
					type: 'GET',
					url: '${pageContext.request.contextPath}/listarOtros',
					data: {
						cod_otro : object
					},
					dataType: 'json',
					success: function(paramJson) {						
						if (paramJson[0] != null) {	
							$('#h_tip_otros').html('Edicion de Otros Conceptos');
							$('#form_tip_otro').trigger("reset");
							$('#txt_mnt_codigo').val(paramJson[0].cod_otro);
							$('#txt_nom_otros').val(paramJson[0].nom_otro);	
