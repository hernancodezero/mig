									...
									<div class="form-group">		
										<div class="col-sm-5">		
											<fieldset class="fsStyle">
												...
												<div class="form-group">	
													<label class="col-sm-5 control-label label-sm no-padding-right">Año:</label>
													<div class="col-sm-2">
		...
		<script type="text/javascript">
			...
			function inicializarDatos() {
				if (!esnulo($('#hid_cod_transferencia').val())) {
					...
					$('#sel_periodo').val('${transferencia.cod_mes}');
					$('#sel_anno').val('${transferencia.cod_anno}');
					// Si hay mas 7 registros activamos la paginacion
					if (parseInt('${count}') > 8) {
						$('#tbo_det_partida').pageMe({pagerSelector : '#ul_pag_det_partida', 
													  showPrevNext : true, 
