 ...
 * @author: SUMERIO.
 */
public class CartaFianzaBean extends MBaseBean {
	...
	private String legalidad;
	private String validacion;
	private String chrNomEstado;
	private String desChrNomEstado;
	...
	/**
	 * @return the concatenado
	 */
	public String getConcatenado() {
		return concatenado;
	}
	/**
	 * @param concatenado the concatenado to set
	 */
	...
	/**
	 * @return the legalidad
	 */
	public String getLegalidad() {
		return legalidad;
	}
	/**
	 * @param legalidad the legalidad to set
	 */
	public void setLegalidad(String legalidad) {
	...
	/**
	 * @return the desChrNomEstado
	 */
	public String getDesChrNomEstado() {
		return desChrNomEstado;
	}
	/**
	 * @param desChrNomEstado the desChrNomEstado to set
	 */
	public void setDesChrNomEstado(String desChrNomEstado) {
		this.desChrNomEstado = desChrNomEstado;
	}
