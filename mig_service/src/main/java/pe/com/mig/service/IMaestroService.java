...
public interface IMaestroService {
	 ...
	 * @throws Exception 
	 */
	public abstract Integer grabarproductos(ProductoBean unidad) throws Exception;
	/**
	 * @param financiero
	 * @return
	 * @throws Exception
	 ...
	 * @throws Exception 
	 */
	public abstract List<UnidadMedidaBean> listarUnidadesMedida(UnidadMedidaBean unidad) throws Exception;
	/**
	 * @param unidad
	 * @return
	 * @throws Exception 
	 */
	public abstract List<TarifaBoletoBean> listarboletos(TarifaBoletoBean unidad) throws Exception;
	/**
	 * @param tipoDocumento
	 * @return
	 * @throws Exception
	 ...
	 * @throws Exception
	 */
	public abstract Integer grabarPersonaCuartaCategoria(PersonaCuartaBean cuarta) throws Exception;
	/**
	 * @param tipoDocumento
	 * @return
	 * @throws Exception
	 */
	public abstract List<CartaFianzaBean> listarCartaFianza(CartaFianzaBean compra) throws Exception;
	/**
	 * @param tipoDocumento
	 * @return
	 * @throws Exception
	
	public abstract List<FiltrosCartaFianzaBean> listarCartaFianza(CartaFianzaBean compra) throws Exception; */
	/**
	 * @param cierre
	 * @return
	 * @throws Exception
